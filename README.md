...
│   ├── comparison/                  # Comparative analysis of different scenarios
│   ├── detailed/                    # Individual plots for each scenario
│   ├── analysis_summary.md          # Executive summary with key analysis results
│   ├── comprehensive_report.md      # Complete statistical report
│   ├── experiments_summary.csv      # Full export of analysis results
│   ├── qualitative_analysis.md      # In-depth qualitative interpretation of experimental results
├── 📁 experiments_organized/         # Organized experiment results
│   ├── rgb_clean_kbest/             # Experiments on clean dataset
│   ├── rgb_gaussian30_kbest/        # Experiments with Gaussian noise
│   ├── rgb_gaussian50_kbest/        # Experiments with stronger Gaussian noise
│   ├── rgb_poisson60_kbest/         # Experiments with Poisson noise
│   └── rgb_salt_pepper25_kbest/     # Experiments with salt & pepper noise
├── 📁 inference_k5_popolar_results/  # Inference results
├── 📁 scripts/                      # Python scripts and utilities
│   ├── 🐍 train_and_save_model.py       # Model training script
│   ├── 🐍 inference_on_dataset.py       # Inference script
│   ├── 🐍 add_noise.py                  # Utility for noise generation
...
│   └── 🔧 generate_noise_datasets.sh    # Script for generating noisy datasets
